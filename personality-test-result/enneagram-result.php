		...
		if($test_score!=""){ ?>
			<!-- <div class="container-fluid"> -->
				<div class="panel panel-primary">
					<div class="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#pers-res1" aria-expanded="true" style="cursor: pointer;">
						<label>Enneagram Result</label>
					</div>
					<div id="pers-res1" class="panel-collapse collapse" aria-expanded="true">
						<div class="panel-body">
							<div class="panel-body">
	                            <!-- Nav tabs -->
	                            <ul class="nav nav-tabs">
	                            	<?php 	foreach($test_score as $tscore){ ?>
			                                	<li <?php if($test_score[0]==$tscore){echo "class='active'";}?>><a href="#enneagramtab_<?=$tscore;?>" data-toggle="tab"><?=$tscore;?></a></li>
	                                <?php 	} ?>
	                            </ul>
	                            ...
	                            <div class="tab-content">
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==1){echo "in active";}?>" id="enneagramtab_1">
										<h3>(1) PERFECTIONIST</h3>
										<p>Ones are motivated by the need to live their life the right way, including improving themselves and the world around them.</p>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==2){echo "in active";}?>" id="enneagramtab_2">
										<h3>(2) HELPER</h3>
										<p>Two are motivated by the need to be loved and valued and to express their positive feelings toward others. Traditionally society has encouraged Two qualities in females more than in males.</p>
										<table class="table table-bordered">
											<thead>
												<tr>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==3){echo "in active";}?>" id="enneagramtab_3">
										<h3>(3) ACHIEVER</h3>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==4){echo "in active";}?>" id="enneagramtab_4">
										<h3>(4) ROMANTIC</h3>
										<p>Fours are motivated by the need to experience their feeling and to be understood, to search for the meaning of life, and to avoid being ordinary.</p>
										<table class="table table-bordered">
											<thead>
												<tr>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==5){echo "in active";}?>" id="enneagramtab_5">
										<h3>(5) OBSERVER</h3>
										<p>Fives are motivated by the need to know and understand everything, to be self-sufficient, and to avoid looking foolish.</p>
										<table class="table table-bordered">
											<thead>
												<tr>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==6){echo "in active";}?>" id="enneagramtab_6">
										<h3>(6) QUESTIONER</h3>
										<p>Sixes are motivated by the need for security. Phobic Sixes are outwardly fearful and seek approval. Counterphobic Sixes confront their fear. Both of these aspects can appear in the same person.</p>
										<table class="table table-bordered">
											<thead>
												<tr>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==7){echo "in active";}?>" id="enneagramtab_7">
										<h3>(7) ADVENTURER</h3>
										<p>Sevens are motivated by the need to be happy and plan enjoyable activities, to contribute to the world, and to avoid suffering and pain.</p>
										<table class="table table-bordered">
											<thead>
												<tr>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==8){echo "in active";}?>" id="enneagramtab_8">
										<h3>(8) ASSERTER</h3>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]==9){echo "in active";}?>" id="enneagramtab_9">
										<h3>(9) PEACEMAKER</h3>
										<p>Nines are motivated by the need to keep the peace, to merge with others, and to avoid conflict. Since they especially, take on qualities of the other eight types, Nines have many variations in their personalities, from gentle and mild-mannered to independent and forceful.</p>
										<table class="table table-bordered">
											<thead>
												<tr>
										...
										<h4>RELATIONSHIPS</h4>
										<li>Nines at their best in a relationship are kind, gentle, reassuring, supportive, loyal, and nonjudgmental.</li>
										<li>Nines at their worst in a relationship are stubborn, passive-aggressive, unassertive, overly accommodating, and defensive.</li>
