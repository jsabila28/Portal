		...
		if($test_score!=""){ ?>
			<!-- <div class="container-fluid"> -->
				<div class="panel panel-primary">
					<div class="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#pers-res5" aria-expanded="true" style="cursor: pointer;">
						<label>What color are you?</label>
					</div>
					<div id="pers-res5" class="panel-collapse collapse" aria-expanded="true">
						<div class="panel-body">
							<div class="panel-body">
	                            <!-- Nav tabs -->
	                            <ul class="nav nav-tabs">
	                            	<?php 	foreach($test_score as $tscore){ ?>
			                                	<li <?php if($test_score[0]==$tscore){echo "class='active'";}?>><a href="#colortab_<?=$tscore;?>" data-toggle="tab"><b><?=$tscore;?></b></a></li>
	                                <?php 	} ?>
	                            </ul>
	                            ...
	                            <div class="tab-content">
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]=="Blue"){echo "in active";}?>" id="colortab_Blue">
	                                	<br>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]=="Green"){echo "in active";}?>" id="colortab_Green">
	                                	<br>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]=="Red"){echo "in active";}?>" id="colortab_Red">
	                                	<br>
	                                ...
	                                <div class="tab-pane fade <?php if($test_score[0]=="Yellow"){echo "in active";}?>" id="colortab_Yellow">
	                                	<br>
										<p style="margin-left:0in; margin-right:0in"><span style="font-size:11pt"><span style="font-family:Calibri,sans-serif"><strong><span style="font-size:10.0pt">YELLOW (Supporter)</span></strong></span></span></p>
