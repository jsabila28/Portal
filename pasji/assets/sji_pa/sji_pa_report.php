            ...
            <div  class="panel-body">
                ...
                <div>
                    ...
                    <select id="areafilter" class="selectpicker" data-live-search="true" title="Select" multiple data-actions-box="true">
                        ...
                        <?php
                            foreach ($hr_pdo->query("SELECT Area_Code, Area_Name FROM tbl_area ORDER BY Area_Name ASC") as $r1) {
            ...
            <div  class="panel-body">
                ...
                <div>
                    ...
                    <select id="outletfilter" class="selectpicker" data-live-search="true" title="Select" multiple data-actions-box="true">
                        <option value="None">None</option>
                        <?php
                            foreach ($hr_pdo->query("SELECT OL_Code, OL_Name FROM tbl_outlet WHERE OL_stat = 'active' ORDER BY OL_Name ASC") as $r1) {
        ...
        <div class="panel panel-default">
            <div  class="panel-body">
                ...
                <div class="pull-right">
                    ...
                    <select id="empfilter" class="selectpicker" data-live-search="true" title="Select" multiple data-actions-box="true">
                        <?php
                            if(get_assign("pa","viewall",$user_empno)){
                                foreach ($hr_pdo->query("SELECT bi_empno, bi_empfname, bi_emplname, bi_empext
                    ...
                    <button id="btnloademp" class="btn btn-default" onclick="emppa()"><i class="fa fa-search"></i></button>
                </div>
