        ...
        .then(response => {
            if(response['status'] == 1){
                if($(this1).attr('curval')){
                    ...
                    targetFinalPrev.text(addCommaToNum(targetFinalPrevTotal.toFixed(2)));
                }
                ...
                if(this1.value){
                    ...
                    targetFinal.text(addCommaToNum(targetFinalTotal.toFixed(2)));
                    ...
                    sourceFinal.text(addCommaToNum(sourceTotal.toFixed(2)));
                }else{
...
async function printProoflist() {
    ...
    divContents += "<p></p>";
    divContents += "<table style='width: 100%; border-collapse: collapse; font-family: Arial;'>";
