		...
		if($test_score!=""){ ?>
			...
			<div class="col-lg-12 col-xl-12">                                       
                ...
                <ul class="nav nav-tabs  tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($test_score[0]==$tscore){echo "class='active'";}?>" data-toggle="tab" href="#disctab_<?=$tscore;?>" role="tab"><b><?=strtoupper($tscore);?></b></a>
                    </li>
                    <?php } ?>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content tabs card-block" style="height: 380px; overflow:auto;">
                    ...
                    <div class="tab-pane <?php if($test_score[0]=="d"){echo "in active";}?>" id="disctab_d" role="tabpanel">
                    ...
                    <div class="tab-pane <?php if($test_score[0]=="i"){echo "in active";}?>" id="disctab_i" role="tabpanel">
                        <div class="container-fluid">
							<table class="table">
								<tbody>
									<tr>
                    ...
                    <div class="tab-pane <?php if($test_score[0]=="s"){echo "in active";}?>" id="disctab_s" role="tabpanel">
                        <div class="container-fluid">
							<table class="table">
								<tbody>
									<tr>
                    ...
                    <div class="tab-pane <?php if($test_score[0]=="c"){echo "in active";}?>" id="disctab_c" role="tabpanel">
                        <div class="container-fluid">
							<table class="table">
								<tbody>
									<tr>
