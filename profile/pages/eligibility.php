                    ...
                    <div class="card-block" id="prof-card">
                      <div id="personal-info">
                        ...
                        <div class="edit-profile">
                          <button class="btn btn-default btn-mini" data-toggle="modal" data-target="#License-<?=$empno?>"><i class="icofont icofont-pencil-alt-2"></i> Add Eligibility/License</button>
                        </div>  
                      </div>
                    </div>
                    <div id="license"></div>
