...
<script type="text/javascript">
	...
	function get_notification(_type1){
		$.post("grievance.php",{ notification: _type1 },function(res1){
	...
	function get_ir(_tab1){
		...
		$.post("grievance.php",{ ir:_tab1 },function(data1){
	...
	function get_13a(_tab1){
		...
		$.post("grievance.php",{ _13a:_tab1 },function(data1){
			var obj1=JSON.parse(data1);
			var txt1 ="<br>";
				...
				txt1 +="<tbody>"; 
				for(x1 in obj1){
					txt1 +="<tr style='cursor: pointer;' onclick=location='?page=13a&no="+obj1[x1][1]+"'>";
					txt1 +="<td>"+obj1[x1][0]+"</td>";
					txt1 +="<td>"+obj1[x1][2]+"</td>";
					txt1 +="<td>"+obj1[x1][3]+"</td>";
					txt1 +="<td>"+obj1[x1][4]+"</td>";
	...
	function get_13b(_tab1){
		...
		$.post("grievance.php",{ _13b:_tab1 },function(data1){
			var obj1=JSON.parse(data1);
			var txt1 ="<br>";
	...
	function get_commitment(){
		...
		$.post("grievance.php",{ commitment:"1" },function(data1){
			var obj1=JSON.parse(data1);
			var txt1 ="<br>";
