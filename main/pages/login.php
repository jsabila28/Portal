    ...
    <div class="container">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <img src="assets/img/coffi.png" class="image" height="250" width="300" alt="" />
          <div class="content">
            <h3>ZenHub</h3>
            <!-- <p>
              A Calm Space for Big Ideas.
            </p> -->
            <p>Your Daily Escape for Energy & Inspiration.</p>
            <!-- <p>Here, You’re More Than a Guest—You Belong.</p>
            <p> Where Your Day Begins and Stress Ends</p> -->
          </div>
        </div>
      </div>
    </div>
